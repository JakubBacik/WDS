...
public:
    ...
    void setupUi(QDialog *ConnectionWithArduino)
    {
        ...
        Connect = new QPushButton(ConnectionWithArduino);
        ...
        Disconnect = new QPushButton(ConnectionWithArduino);
        ...
        QObject::connect(Connect, SIGNAL(clicked()), ConnectionWithArduino, SLOT(push()));
    ...
    void retranslateUi(QDialog *ConnectionWithArduino)
    {
        ...
        Connect->setText(QApplication::translate("ConnectionWithArduino", "Connect", nullptr));
        Disconnect->setText(QApplication::translate("ConnectionWithArduino", "Disconnect", nullptr));
    } // retranslateUi

};

namespace Ui {
    class ConnectionWithArduino: public Ui_ConnectionWithArduino {};
} // namespace Ui
